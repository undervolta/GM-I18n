...
show_debug_message($"ref_welcome = {ref_welcome}")
show_debug_message($"ref_text = {ref_text}")
show_debug_message($"ref_arr = {ref_arr}")
show_debug_message($"global.ref_struct = {global.ref_struct}")
